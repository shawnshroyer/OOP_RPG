    ...
    public class Hero
    {
        ...
        */
        ...
        public void EquipWeapon() {
            ...
            {
                Console.WriteLine($"\nYou currently have {EquippedWeapon.Name} equipped and will have to remove it to equip a new weapon.");
        ...
        public void RemoveWeapon()
        {
            if (!(this.EquippedWeapon.Name is null))
            {
                Console.WriteLine($"\nYou currently have {EquippedWeapon.Name} of {EquippedWeapon.Strength} strength equipped");
                ...
                switch (input.ToLower())
                {
                    ...
                    case "y":
                        ...
                        Console.WriteLine($"\nYour {EquippedWeapon.Name} of {EquippedWeapon.Strength} strength has been removed.");
            ...
            {
                Console.WriteLine($"\nYou currently have no Weapon equipped and strongly recommend you equip one.");
        ...
        public void RemoveArmor() {
            if (!(this.EquippedArmor.Name is null))
            {
                Console.WriteLine($"\nYou currently have {EquippedArmor.Name} of {EquippedArmor.Defense} Defense equipped");
                Console.WriteLine($"Would you like to remove {EquippedArmor.Name} of {EquippedArmor.Defense} Defense?");

                Console.Write("/nYes (y) or No (n): ");
                var input = Console.ReadLine();
                ...
                switch (input.ToLower())
                {
                    ...
                    case "y":
                        ...
                        Console.WriteLine($"\nYour {EquippedArmor.Name} of {EquippedArmor.Defense} Defense has been removed.");
            ...
            {
                Console.WriteLine($"\nYou currently have no Armor equipped and strongly recommend you equip one.");
            ...
            if (this.PotionBag.Any())
            {
                ...
                if (Int32.TryParse(select, out bagLocation))
                {
                    if (this.PotionBag[bagLocation - 1] != null)
                    {
                        ...
                        {
                            if (HpDifference <= this.PotionBag[bagLocation - 1].Hp) {
                                Console.WriteLine($"\nYou are only missing {HpDifference} health points,\n" +
                    ...
                    {
                        Console.WriteLine($"\nThere is nothing in this part of your bag!");
